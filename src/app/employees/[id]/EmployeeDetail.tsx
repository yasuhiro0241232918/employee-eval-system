    ...
    <div>
      ...
      <div className="flex items-center gap-3 mb-4 bg-amber-50 border border-amber-100 rounded-xl px-4 py-3">
        ...
        <input
          ...
          className="w-16 text-center border border-amber-300 rounded-lg px-2 py-1 text-sm outline-none focus:border-amber-500 bg-white"
        />
      ...
      {loading ? <p className="text-sm text-slate-400">読み込み中...</p> : (
        <div className="overflow-auto" style={{ maxHeight: "calc(100vh - 360px)" }}>
          <table className="text-xs border-collapse" style={{ marginLeft: 0 }}>
